pipeline {
     environment {
       ...
       APP_NAME = "christ"
       STG_API_ENDPOINT = "ip10-0-2-3-ckfsu4st654gqaevknq0-1993.direct.docker.labs.eazytraining.fr"  
       STG_APP_ENDPOINT = "ip10-0-2-3-ckfsu4st654gqaevknq0-80.direct.docker.labs.eazytraining.fr"
       PROD_API_ENDPOINT = "ip10-0-2-4-ckfsu4st654gqaevknq0-1993.direct.docker.labs.eazytraining.fr"
       PROD_APP_ENDPOINT = "ip10-0-2-4-ckfsu4st654gqaevknq0-80.direct.docker.labs.eazytraining.fr"
       INTERNAL_PORT = "5000"
